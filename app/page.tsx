  ...
  return (
    <section id="about" className="relative py-24 bg-dark-900" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <span className="text-xs tracking-[0.3em] uppercase text-accent-1 font-medium">À propos</span>
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-3">Qui suis-je ?</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative group">
              <div className="relative w-72 h-72 mx-auto rounded-2xl overflow-hidden neon-border">
                <img src="/images/avatar.jpg" alt={PROFILE.displayName} className="w-full h-full object-cover" />
          ...
          >
            <h3 className="text-2xl font-bold text-white mb-4">
              Étudiant en L3 Math-Info, passionné par <span className="text-gradient">l'innovation</span>
            </h3>
    ...
    <section id="skills" className="relative py-24 bg-dark-800" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        <div className={cn("text-center mb-16 transition-all duration-700", visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
          <span className="text-xs tracking-[0.3em] uppercase text-accent-2 font-medium">Compétences</span>
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-3">Ma stack technique</h2>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          {skills.map((skill, i) => {
            const Icon = (skillIcons as any)[i] || DefaultIcon;
            return (
              <div
                key={skill.name}
                className={cn(
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center text-white text-sm font-bold" style={{ background: skill.color + "33" }}>
                    <Icon />
                  </div>
...
function Projects() {
  ...
  return (
    <section id="projects" className="relative py-24 bg-dark-900" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        <div className={cn("text-center mb-16 transition-all duration-700", visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
          <span className="text-xs tracking-[0.3em] uppercase text-accent-3 font-medium">Projets</span>
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-3">Mes réalisations</h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className="p-6">
                <span className="text-xs font-medium" style={{ color: project.color }}>{project.subtitle}</span>
...
function Experience() {
  ...
  return (
    <section id="experience" className="relative py-24 bg-dark-800" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        <div className={cn("text-center mb-16 transition-all duration-700", visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
          <span className="text-xs tracking-[0.3em] uppercase text-accent-1 font-medium">Expérience</span>
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-3">Mon parcours</h2>
        </div>
        ...
        <div className="relative">
          ...
          {experience.map((exp, i) => (
            <div
              ...
              style={{ transitionDelay: `${i * 150}ms` }}
            >
              <div className={cn("md:w-1/2", i % 2 === 0 ? "md:pr-12 md:ml-0" : "md:pl-12 md:ml-auto")}>
                <div className="glass rounded-2xl p-6 border border-white/5 hover:neon-border transition-all duration-300">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-xs px-3 py-1 rounded-full glass-light text-accent-1">{exp.period}</span>
                  </div>
...
function Testimonials() {
  ...
  return (
    <section className="relative py-24 bg-dark-900" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        <div className={cn("text-center mb-16 transition-all duration-700", visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
          <span className="text-xs tracking-[0.3em] uppercase text-accent-2 font-medium">Témoignages</span>
          <h2 className="text-3xl md:text-5xl font-bold text-white mt-3">Ce qu'ils disent</h2>
        </div>
...
function Contact() {
  ...
  return (
    <section id="contact" className="relative py-24 bg-dark-800" ref={ref}>
      <div className="max-w-7xl mx-auto px-6">
        <div className={cn("text-center mb-16 transition-all duration-700", visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
          <span className="text-xs tracking-[0.3em] uppercase text-accent-3 font-medium">Contact</span>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <form
            ...
            className={cn("glass rounded-2xl p-8 border border-white/5 space-y-6 transition-all duration-700", visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8")}
          >
            <div>
